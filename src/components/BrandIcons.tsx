...
export function FacebookIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M13.5 21.5v-8.2h2.75l.41-3.2h-3.16V8.06c0-.93.26-1.56 1.59-1.56h1.7V3.64c-.3-.04-1.3-.13-2.47-.13-2.44 0-4.11 1.49-4.11 4.22v2.36H7.46v3.2h2.75v8.2h3.29Z" />
    </svg>
  );
}
